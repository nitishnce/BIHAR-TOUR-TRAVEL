...
public class upass extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            s1=request.getParameter("opass");
          s2=request.getParameter("npass");
          String s=null;
          ...
          if(s2.equals(s3))
          {
              ...
              ResultSet ty=st.executeQuery("SELECT Password from registration where Email='"+session.getAttribute("mail")+"'");
              if(ty.next())
              {
            ...
            rd.include(request, response);}else{  RequestDispatcher rd=request.getRequestDispatcher("AProfile.jsp");
